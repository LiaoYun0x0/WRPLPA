...
from models.ResnetrecursiveFPN import ResnetrecursiveFPN
...
class MatchingNet(nn.Module):
    def __init__(
        ...
        self.backbone = ResnetrecursiveFPN()
        ...
        self.conv2d = nn.Conv2d(128, d_fine_model, 1, 1)
    ...
    def forward(self, samples0, samples1, gt_matrix):
        ...
        mdesc0, fine_featmap0 = self.backbone(samples0)
        mdesc1, fine_featmap1 = self.backbone(samples1)
        mdesc0 = mdesc0.view([mdesc0.size()[0], -1,mdesc0.size()[1]])
        mdesc1 = mdesc1.view([mdesc1.size()[0], -1,mdesc1.size()[1]])
