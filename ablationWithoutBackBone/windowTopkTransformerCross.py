...
class WindowAttention(nn.Module):
    ...
    def forward(self, x,source,mask0=None,mask1=None):
        ...
        return x_win_attn,s_win_attn #[b*num_window,h*w,c]
...
class WinTopKAttention(nn.Module):
    ...
    def forward(self,x_win_attn,s_win_attn,attn_name,mask0=None,mask1=None): #x: [b*num_window,h*w,c]
        ...
        if attn_name == 'self':
            ...
            window_attention_topk1 = torch.gather(x_win_attn, 1, indices.unsqueeze(2).expand(-1, -1, 256))
            ...
            window_attention_topk2 = torch.gather(s_win_attn, 1, indices.unsqueeze(2).expand(-1, -1, 256))
